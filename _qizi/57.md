...
>t/n: Trying a new style where I changed more passive voice -> active voice since that reads better in English. Trying to also capture the meaning more rather than word by word, but I haven't pointed out all the smaller sections yet, maybe in time.
...
No one clearly could see what exactly happened at the scene. They only saw that the black bear quivered all over one time, then softly fell down. The green light above the arena turned on, and the timer stopped.
