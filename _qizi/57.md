...
>t/n: Trying a new style where I changed more passive voice -> active voice since that reads better in English. Trying to also capture the meaning more rather than word by word, and I haven't pointed out all the smaller sections yet, maybe in time.
